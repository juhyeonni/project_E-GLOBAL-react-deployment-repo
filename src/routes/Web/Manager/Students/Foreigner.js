  ...
  useEffect(() => {
    getAdminSection({ year: `${moment().format('YYYY')}` }).then((res) => {
      ...
      res.data.data.forEach((v, i) => {
        if (moment(Date.now()).isBetween(moment(v.sect_start_date), moment(v.sect_end_date))) {
          index = i;
        }
      });
      ...
      <div className="content">
        <div className="sub_title">
          <div className="top_semester">
            ...
            <p className="tit" style={{ marginLeft: '10px', marginTop: '3px', fontSize: '14px' }}>
              {selectYear}학년도
            </p>
            <p
              className="tit"
                ...
                <table className="student_manage_table">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      >
                        <input type="hidden" id="std_for_lang" value={false} />
                        언어 <img src="/global/img/table_align_arrow.gif" alt="언어 기준 정렬" />
                      </th>
                      <th
                        rowSpan="2"
                        className="align"
                      ...
                      >
                        <input type="hidden" id="std_for_country" value={false} />
                        국가명{' '}
                        <img src="/global/img/table_align_arrow.gif" alt="국가명 기준 정렬" />
                      </th>
                      <th
                        rowSpan="2"
                        className="align"
                      ...
                      >
                        <input type="hidden" id="std_for_state_of_favorite" value={false} />
                        즐겨찾기{' '}
                        <img src="/global/img/table_align_arrow.gif" alt="즐겨찾기 기준 정렬" />
                      </th>
                      <th colSpan="3">유학생 정보</th>
                      <th
                        colSpan={
                          dataSet && dataSet.data
                            ? Object.keys(dataSet.data[0].work_time).length + 1
                            : 5
                        }
                      >
                        활동시간
                      ...
                      <th
                        rowSpan="2"
                        className="align"
                        onClick={() => sort('std_for_num_of_delay_permission')}
                      >
                        <input type="hidden" id="std_for_num_of_delay_permission" value={false} />
                        예약 미승인
                        <br />
                        횟수
                        <img
                      ...
                      >
                        <input type="hidden" id="std_for_num_of_delay_input" value={false} />
                        결과 지연
                        <br />
                        입력 횟수
                        <img
                    ...
                    <tr>
                      ...
                      >
                        <input type="hidden" id="std_for_dept" value={false} />
                        계열학과
                        <img src="/global/img/table_align_arrow.gif" alt="계열학과 기준 정렬" />
                      </th>
                      <th
                        rowSpan="2"
                        className="align"
                      ...
                      >
                        ...
                        합계
                        <img src="/global/img/table_align_arrow.gif" alt="합계 기준 정렬" />
                      </th>
                      ...
                      {!loading &&
                        ...
                        Object.keys(dataSet.data[0].work_time).map((v) => (
                          ...
                          >
                            <input type="hidden" id={`${v}`} value={false} />
                            {v}
                            <img src="/global/img/table_align_arrow.gif" alt={`${v} 기준 정렬`} />
                          </th>
                        ))}
                    </tr>
                  </thead>
                  <tbody>
                    {dataSet &&
                      ...
                      dataSet.data.map((value, index) => {
                        let toggle = value.std_for_state_of_favorite ? true : false;
                        return (function () {
                          return (
                            <tr
                              className={
                            ...
                            >
                              <td>
                                <div className="table_check">
                                  <input type="checkbox" id={value.std_for_id} name="" />
                              ...
                              <td>
                                <div
                                  ...
                                  onClick={(e) => {
                                    ...
                                    let item = document.getElementById(`fav_${value.std_for_id}`);
                              ...
                              <td
                                className="name"
                                onMouseOver={() => {
                                  document.getElementById(`hover_btn_${index}`).className =
                                    'hover_btn';
                                }}
                                onMouseOut={() => {
                                  document.getElementById(`hover_btn_${index}`).className =
                              ...
                              >
                                {value.std_for_name}
                                <div id={`hover_btn_${index}`} className="hover_btn hover_off">
                                  <div className="area">
                                    <div
                                      className="navy"
                                      onClick={() => {
                                        if (
                                          window.confirm('비밀번호를 초기화 시키겠습니까?') === true
                                        ) {
                                          patchAdminForeignerAccount(value.std_for_id).then(
                                            (res) => {
                                              setPending(true);
                              ...
                              <td>{value.std_for_num_of_delay_permission}</td>
                              <td>{value.std_for_num_of_delay_input}회</td>
                            </tr>
                          );
                        })();
                      })}
